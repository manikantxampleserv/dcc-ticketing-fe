        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 max-w-md w-full mx-4">
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">Setting up your workspace</p>
            </div>
            ...
            <div className="space-y-2">
              <p className="text-sm text-gray-700 font-medium">Loading your data...</p>
            ...
            <div className="pt-4 border-t border-gray-100">
              <p className="text-xs text-gray-500">Authenticating • Loading tickets • Preparing interface</p>
            </div>
          </div>
        </div>
      </div>
